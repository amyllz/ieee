      ...
      <div>
        ...
        <Row type="flex" justify="center" >
          <div className='content'>
            ...
            <p><span className='CallforPapers-highlight'>Submission of Signal Processing Letters Papers – </span>Authors of IEEE Signal Processing Letters (SPL) papers will be given the opportunity to present their work at SAM 2020, subject to space availability and approval by the Technical Program Chairs. SPL papers published between <span className='CallforPapers-highlight'>15th June, 2019 </span>and <span className='CallforPapers-highlight'>15th February, 2020 </span>are eligible for presentation at SAM 2020. Requests for presentation of SPL papers should be made by emailing the Technical Program Chairs as early as possible and the latest by <span className='CallforPapers-highlight'>31st May, 2020</span>. However, to take advantage of the advance registration rate (<span className='CallforPapers-highlight'>20 May 2020</span>), please send your request by <span className='CallforPapers-highlight'>30 April 2020</span>. Decision will be made within two weeks of receiving the request. Approved requests for presentation must have one author/presenter registered for SAM 2020. </p>
